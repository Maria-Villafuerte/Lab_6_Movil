package com.example.story_laboratorio6_navegacion_1.Pantallas.Favoritos.viewmodel
...
@Composable
fun Favoritos(navController: NavController = rememberNavController()){
    Column() {
        AppBar(title = "Favoritos", navController = navController)
